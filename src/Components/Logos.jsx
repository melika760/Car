...
const Logos = () => {
 ...
 {Carlogos.map((item)=>(<div key={item.make} className='w-[220px] h-[120px] max-md:w-[90%] border border-gray-200 shadow-md rounded-md flex flex-col justify-center items-center p-2 hover:bg-gray-100 hover:shadow-2xl cursor-pointer'>
    <div>
